...
if(!isset($_GET['suppID'])){
    die("No item is being specified");
}
...
if($Connection = oci_connect("username","password")){ // this user name and password is wrong for secutity reasons
    print"<br>";
    print"<h2 style ='font-weight: bold;'>Supplier Items:  </h2>";
    print"<br>";
    $sql = "SELECT * FROM ITEM WHERE suppID# = :suppID";


    //Parase Oracle query
    $Statement = oci_parse($Connection,$sql);

    oci_bind_by_name($Statement,":suppID",$suppID);
    ...
    print"<br>";
    print"<h2>Supplier has $numrows Items  </h2>";
