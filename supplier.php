...
if($Connection = oci_connect("username","password")){ // this user name and password is wrong for secutity reasons
    print"<br>";
    print"<h2 style ='font-weight: bold;'>Our Suppliers:  </h2>";
    print"<br>";
    print"Click on the Suppliers to view Items";
    ...
    while(oci_fetch($Statement)){
        ...
        $suppID = oci_result($Statement,'SUPPID#');
        print"<tr onclick=\"window.location='items.php?suppID=$suppID'\">";
        for($i=1; $i<=$numcols; $i++){
    ...
    print"<br>";
    print"<h2>We have $numrows suppliers  </h2>";
    print"<br>";
    print"<br>";
    print"<br>";
    print"<br>";
